...
export const execTransform = (assetDir, downloaded, profile, job, logger, clock) => __awaiter(void 0, void 0, void 0, function* () {
...
export const transformAsset = (xform, job, destinations) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // run the transform
    const outDir = yield execTransform(xform.config.assetDir, downloaded, profile, job, xform.config.logger, xform.clock);
    if (!outDir) {
