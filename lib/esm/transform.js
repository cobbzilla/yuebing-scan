...
export const execTransform = (assetDir, downloaded, profile, job, logger, conn, analysisResults) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield applyProfile(downloaded, profile.media, profile.name, outDir, assetPath(job.asset), conn, analysisResults);
...
export const transformAsset = (xform, job, destinations) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // run the transform
    const response = yield execTransform(xform.config.assetDir, downloaded, profile, job, xform.config.logger, downloadResult.conn, analysisResults);
    if (!response) {
