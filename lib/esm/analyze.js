...
import { applyProfile, assetPath, fileExtWithoutDot, loadProfile, } from "yuebing-media";
...
export const analyzeAsset = (analyzer, sourceAsset, downloaded, profile, conn) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield execAnalyze(assetDir, downloaded, profile, profileJob, analyzer.config.logger, sourceAsset, conn, analyzer.clock);
