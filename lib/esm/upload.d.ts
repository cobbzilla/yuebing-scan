...
export declare const uploadFiles: (result: TransformResult, profile: ParsedProfile, job: ProfileJobType, destinations: DestinationType[], daemon: TransformerDaemonType) => Promise<false | undefined>;
